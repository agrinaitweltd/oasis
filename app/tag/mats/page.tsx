...
export const metadata: Metadata = {
  title: "MATs - Arbor",
  description: "Posts about MATs written by sasaljstojkovic, Anna Christie, and Harriet Cheng",
};
...
export default function Page() {
  return (
    <div
      ...
      dangerouslySetInnerHTML={{ __html: `<h1 style="line-height:1;padding-top:var(--wp--preset--spacing--50)" class="alignwide wp-block-query-title">Tag: <span>MATs</span></h1>
...
<div class="taxonomy-post_tag wp-block-post-terms"><span class="wp-block-post-terms__prefix">in </span><a href="/tag/mats/" rel="tag">MATs</a></div></div>
</div>
</div>

<div class="wp-block-post-excerpt has-text-color has-contrast-2-color has-small-font-size wp-container-content-32e3a40d"><p class="wp-block-post-excerpt__excerpt">Where did your wellbeing journey start as a trust? Sarah Orves: We started our wellbeing journey back in 2019, even before COVID-19 brought wellbeing to the forefront. Often,  in schools and trusts, it’s easy to work on the same persistent problems every year: attendance, staff retention, motivation, etc.  We decided to take a step back&hellip; </p></div>
...
<div class="wp-block-post-excerpt has-text-color has-contrast-2-color has-small-font-size wp-container-content-32e3a40d"><p class="wp-block-post-excerpt__excerpt">Today we’re excited to launch the next evolution of MAT MIS for trust central teams. Brilliant individually, MAT MIS, School MIS and Data Warehouse from Arbor work even better together &#8211; giving your trust one, joined-up mission control. Give your schools the tools they need to manage their day-to-day, give your central team the ability&hellip; </p></div>
...
<div class="wp-block-post-excerpt has-text-color has-contrast-2-color has-small-font-size wp-container-content-32e3a40d"><p class="wp-block-post-excerpt__excerpt">Arbor Education is today launching a new partnership with the Confederation of School Trusts (CST) to help schools and trusts transform the way they work, maximise the power of data, and ultimately help to improve education. The Confederation of School Trusts (CST) is the national organisation and sector body for school trusts in England advocating&hellip; </p></div>
